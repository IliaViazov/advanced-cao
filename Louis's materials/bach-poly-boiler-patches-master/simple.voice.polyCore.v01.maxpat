...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.0, 567.0, 150.0, 47.0 ],
					"text" : "data outlets: will be used to monitor voice allocation outside of the poly~ object"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 538.0, 35.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.0, 538.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 513.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 25.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 540.5, 436.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 768.0, 367.0, 175.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 473.0, 444.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.452475247524944, 451.0, 59.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.168627450980392, 0.207843137254902, 1.0, 1.0 ],
					"id" : "obj-23",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 789.0, 490.0, 58.0, 22.0 ],
					"text" : "r mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 750.452475247524944, 541.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 334.0, 735.324607329842934, 244.0, 75.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 552.0, 55.0, 20.0 ],
					"text" : "<outlet>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.0, 4.0, 47.0, 20.0 ],
					"text" : "<inlet>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 709.0, 45.0, 297.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.952475247524944, 67.0, 268.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 728.952475247524944, 30.0, 425.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 709.0, 8.0, 317.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 567.0, 272.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 432.0, 557.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.0, 18.0, 217.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 377.833333333333371, 409.0, 114.166666666666629, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 252.0, 577.452475247524944, 22.0 ],
					"text" : "t f b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 8.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.740709543228149, 0.0, 1.0 ],
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.740260064601898, 0.0, 1.0 ],
					"destination" : [ "obj-18", 0 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 482.5, 477.0, 735.0, 477.0, 735.0, 528.0, 759.952475247524944, 528.0 ],
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Desktop/Myclasses/ADVCAO-<aterials/bach-poly-boiler-patches-master",
				"patcherrelativepath" : ".",
				"type" : "GIFf",
				"implicit" : 1
			}
